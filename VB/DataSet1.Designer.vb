	...
	Partial Public Class DataSet1
		...
		Partial Public Class CustomerInfoRow
			...
			Public Property Column1() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCustomerInfo.Column1Column))))
			...
			Public Property Column2() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCustomerInfo.Column2Column))))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Column3() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCustomerInfo.Column3Column))))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Column4() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCustomerInfo.Column4Column))))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Column5() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCustomerInfo.Column5Column))))
					Catch e As Global.System.InvalidCastException
