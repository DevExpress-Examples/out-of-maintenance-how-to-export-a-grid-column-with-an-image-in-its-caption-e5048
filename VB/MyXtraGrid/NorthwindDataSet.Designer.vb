    ...
    Partial Public Class Order_DetailsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order Details] ([OrderID], [ProductID], [UnitPrice], [Quantity"& _ 
                "], [Discount]) VALUES (@OrderID, @ProductID, @UnitPrice, @Quantity, @Discount);"&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WH"& _ 
                "ERE (OrderID = @OrderID) AND (ProductID = @ProductID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Order Details] SET [OrderID] = @OrderID, [ProductID] = @ProductID, "& _ 
                ...
                "ount] = @Original_Discount));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderID, ProductID, UnitPrice, Quantity, Di"& _ 
                "scount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @Product"& _ 
                "ID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.My.Settings.Default.NorthwindConnectionString
        End Sub
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([CustomerID], [EmployeeID], [OrderDate], [RequiredDat"& _ 
                ...
                "dress, @ShipCity, @ShipRegion, @ShipPostalCode, @ShipCountry);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderID, C"& _ 
                "ustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, S"& _ 
                "hipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry FROM Ord"& _ 
                "ers WHERE (OrderID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Orders] SET [CustomerID] = @CustomerID, [EmployeeID] = @EmployeeID,"& _ 
                ...
                " = 1 AND [ShipCountry] IS NULL) OR ([ShipCountry] = @Original_ShipCountry)));"&Global.Microsoft.VisualBasic.ChrW(10)&"SE"& _ 
                "LECT OrderID, CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, Ship"& _ 
                "Via, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipC"& _ 
