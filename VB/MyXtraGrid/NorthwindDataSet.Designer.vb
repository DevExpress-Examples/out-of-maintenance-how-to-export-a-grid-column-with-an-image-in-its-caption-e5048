...
Namespace MyXtraGrid
	...
	Partial Public Class NorthwindDataSet
		...
		Partial Public Class Order_DetailsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddOrder_DetailsRow(ByVal parentOrdersRowByFK_Order_Details_Orders As OrdersRow, ByVal ProductID As Integer, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single) As Order_DetailsRow
				...
				If (parentOrdersRowByFK_Order_Details_Orders IsNot Nothing) Then
	...
	End Class
End Namespace
Namespace MyXtraGrid.NorthwindDataSetTableAdapters
	...
	Partial Public Class Order_DetailsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Order Details] WHERE (([OrderID] = @Original_OrderID) AND ([Pr" & "oductID] = @Original_ProductID) AND ([UnitPrice] = @Original_UnitPrice) AND ([Qu" & "antity] = @Original_Quantity) AND ([Discount] = @Original_Discount))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order Details] ([OrderID], [ProductID], [UnitPrice], [Quantity], [Discount]) VALUES (@OrderID, @ProductID, @UnitPrice, @Quantity, @Discount);" & ControlChars.CrLf & "SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Order Details] SET [OrderID] = @OrderID, [ProductID] = @ProductID, [UnitPrice] = @UnitPrice, [Quantity] = @Quantity, [Discount] = @Discount WHERE (([OrderID] = @Original_OrderID) AND ([ProductID] = @Original_ProductID) AND ([UnitPrice] = @Original_UnitPrice) AND ([Quantity] = @Original_Quantity) AND ([Discount] = @Original_Discount));" & ControlChars.CrLf & "SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)"
		...
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Decimal, ByVal Original_Quantity As Short, ByVal Original_Discount As Single) As Integer
			...
			Me.Adapter.DeleteCommand.Parameters(2).Value = (CDec(Original_UnitPrice))
			Me.Adapter.DeleteCommand.Parameters(3).Value = (CShort(Fix(Original_Quantity)))
			Me.Adapter.DeleteCommand.Parameters(4).Value = (CSng(Original_Discount))
		...
		Public Overridable Function Insert(ByVal OrderID As Integer, ByVal ProductID As Integer, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single) As Integer
			Me.Adapter.InsertCommand.Parameters(0).Value = (CInt(Fix(OrderID)))
		...
		Public Overridable Function Update(ByVal OrderID As Integer, ByVal ProductID As Integer, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single, ByVal Original_OrderID As Integer, ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Decimal, ByVal Original_Quantity As Short, ByVal Original_Discount As Single) As Integer
			Me.Adapter.UpdateCommand.Parameters(0).Value = (CInt(Fix(OrderID)))
			...
			Me.Adapter.UpdateCommand.Parameters(8).Value = (CShort(Fix(Original_Quantity)))
			Me.Adapter.UpdateCommand.Parameters(9).Value = (CSng(Original_Discount))
